...
public class BaseController : Controller
{
	...
	protected async Task CreateDefaultUser()
	{
		...
		var usuario = new ApplicationUser(Guid.NewGuid().ToString(), "emanuelacu@gmail.com", "emanuelacu@gmail.com", "Enmanuelle", "Acuña", "Arguedas", "206830685", true);
	...
	protected IList<SelectListItem> CargarListaSeleccionRoles()
	{
