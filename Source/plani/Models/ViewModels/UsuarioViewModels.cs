...
public class UsuariosIndexViewModel {
    ...
    public UsuariosIndexViewModel(ApplicationUser usuario, string roles) {
        ...
        Nombre = string.Format(new CultureInfo("es-CR"), "{0} {1} {2}", arg0: usuario.Name, arg1: usuario.FirstLastName, arg2: usuario.SecondLastName);
...
public class RestablecerContrasenaViewModel {
    ...
    [Display(Name = "Contraseña")]
    [Required(ErrorMessage = "La contraseña es requerida.")]
    [StringLength(maximumLength: 100, ErrorMessage = "La {0} debe contener al menos {2} caracteres.", MinimumLength = 6)]
    [DataType(dataType: DataType.Password)]
    public string Contrasena { get; set; }
...
public class AgregarUsuarioViewModel {
    ...
    [StringLength(maximumLength: 50, ErrorMessage = "El primer apellido no puede exceder los 50 caracteres.")]
    public string PrimerApellido { get; set; }

    [Display(Name = "Segundo apellido")]
    [Required(ErrorMessage = "El segundo apellido es requerido.")]
    [StringLength(maximumLength: 50, ErrorMessage = "El segundo apellido no puede exceder los 50 caracteres.")]
    public string SegundoApellido { get; set; }

    [Display(Name = "Número de identificación")]
    [Required(ErrorMessage = "El número de identificación es requerido.")]
    [StringLength(maximumLength: 50, ErrorMessage = "El número de identificacion no puede exceder los 50 caracteres.")]
    public string NumeroIdentificacion { get; set; }

    [Display(Name = "Correo electrónico")]
    [Required(ErrorMessage = "El correo electrónico es requerido.")]
    [StringLength(maximumLength: 50, ErrorMessage = "El correo electrónico no puede exceder los 50 caracteres.")]
    public string CorreoElectronico { get; set; }
    ...
    public ApplicationUser Entidad() {
        return new ApplicationUser(Guid.NewGuid().ToString(), correo: CorreoElectronico, nombre: Nombre,
            primerApellido: PrimerApellido, segundoApellido: SegundoApellido, identificacion: NumeroIdentificacion, activo: true);
    }
}
...
public class EditarUsuarioViewModel {
    ...
    [Display(Name = "Número de identificación")]
    [Required(ErrorMessage = "El número de identificación es requerido.")]
    [StringLength(maximumLength: 50, ErrorMessage = "El número de identificación no puede exceder los 50 caracteres.")]
    public string NumeroIdentificacion { get; set; }
    ...
    public ApplicationUser Entidad() {
        return new ApplicationUser(id: IdUsuario, correo: CorreoElectronico, nombre: Nombre, primerApellido: PrimerApellido,
            segundoApellido: SegundoApellido, identificacion: NumeroIdentificacion, activo: true);
    }
}
