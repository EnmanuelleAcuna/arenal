...
public class NavigationSidebarViewComponent : ViewComponent {
    ...
    public IViewComponentResult Invoke() {
        ...
        NavigationViewModel viewModel = new() {
    ...
    private List<NavigationSection> BuildNavigationSections() {
        List<NavigationSection> sections = new();
        ...
        NavigationSection sesionesSection = BuildSesionesSection();
        if (sesionesSection.SubmenuItems.Any()) {
            sections.Add(item: sesionesSection);
        }
    ...
    private NavigationSection BuildSesionesSection() {
        List<NavigationLink> submenuItems = new();

        bool isAdmin = User.IsInRole("Administrador");
        bool isCoordinador = User.IsInRole("Coordinador");
